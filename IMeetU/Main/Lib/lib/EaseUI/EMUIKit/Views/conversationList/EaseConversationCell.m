...
+ (void)initialize
{
    ...
    cell.titleLabelColor = [UIColor colorWithR:91 G:91 B:91];
    cell.titleLabelFont = [UIFont systemFontOfSize:15];
    cell.detailLabelColor = [UIColor colorWithR:128 G:128 B:128];
    cell.detailLabelFont = [UIFont systemFontOfSize:12];
    cell.timeLabelColor = [UIColor colorWithR:176 G:176 B:176];
...
- (void)_setupSubview
{
    ...
    _avatarView.imageView.backgroundColor = [UIColor clearColor];
